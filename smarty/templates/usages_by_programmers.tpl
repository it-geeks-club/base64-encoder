          ...
          <tr>
            <td>
              ...
              <dl>
                <dt>Parameters</dt>
                <dd>
                  <code>s</code> — is the string to encode.<br/>
                  Optional <code>altchars</code> must be a string of at least length 2 (additional characters are ignored) which specifies an alternative alphabet for the + and / characters. This allows an application to e.g. generate URL or filesystem safe Base64 strings. The default is None, for which the standard Base64 alphabet is used.
                </dd>
              </dl>
              <dl>
                <dt>Return values</dt>
...
print(encoded)</code>
            ...
            <td>
              ...
              <dl>
                <dt>Parameters</dt>
                <dd>
                  <code>s</code> — is the string to decode.<br/>
                  Optional <code>altchars</code> must be a string of at least length 2 (additional characters are ignored) which specifies the alternative alphabet used instead of the + and / characters.
                </dd>
              </dl>
              <dl>
                <dt>Return values</dt>
